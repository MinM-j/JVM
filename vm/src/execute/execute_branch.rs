...
impl Frame {
    pub fn branch_16(&mut self, offset: i16) -> Result<(), JVMError> {
    ...
    pub fn branch_32(&mut self, offset: i32) -> Result<(), JVMError> {
    ...
    pub fn ifeq(&mut self, offset: i16) -> Result<(), JVMError> {
    ...
    pub fn ifne(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let value = self.pop_expect_int()?;
        if value != 0 {
            self.branch_16(offset)?;
    ...
    pub fn iflt(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let value = self.pop_expect_int()?;
        if value < 0 {
            self.branch_16(offset)?;
    ...
    pub fn ifge(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let value = self.pop_expect_int()?;
        if value >= 0 {
            self.branch_16(offset)?;
    ...
    pub fn ifgt(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let value = self.pop_expect_int()?;
        if value > 0 {
            self.branch_16(offset)?;
    ...
    pub fn ifle(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let value = self.pop_expect_int()?;
        if value <= 0 {
            self.branch_16(offset)?;
    ...
    pub fn ifnull(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
    ...
    pub fn ifnonnull(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(1)?;
        let reference = self.pop_expect_reference()?;
    ...
    pub fn if_icmpeq(&mut self, offset: i16) -> Result<(), JVMError> {
    ...
    pub fn if_icmpne(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let value2 = self.pop_expect_int()?;
        let value1 = self.pop_expect_int()?;
        if value1 != value2 {
    ...
    pub fn if_icmplt(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let value2 = self.pop_expect_int()?;
        let value1 = self.pop_expect_int()?;
        if value1 < value2 {
    ...
    pub fn if_icmpge(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let value2 = self.pop_expect_int()?;
        let value1 = self.pop_expect_int()?;
        if value1 >= value2 {
    ...
    pub fn if_icmpgt(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let value2 = self.pop_expect_int()?;
        let value1 = self.pop_expect_int()?;
        if value1 > value2 {
    ...
    pub fn if_icmple(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let value2 = self.pop_expect_int()?;
        let value1 = self.pop_expect_int()?;
        if value1 <= value2 {
    ...
    pub fn if_acmpeq(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
    ...
    pub fn if_acmpne(&mut self, offset: i16) -> Result<(), JVMError> {
        self.ensure_operands(2)?;
        let ref2 = self.pop_expect_reference()?;
        let ref1 = self.pop_expect_reference()?;
        if !std::ptr::eq(&ref1, &ref2) {
